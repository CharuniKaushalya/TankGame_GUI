...
namespace Pathfinding
{
    ...
    public class Tank
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(tankTexture, location, null, Color.White, facingDirection, tankTextureCenter, scale, SpriteEffects.None, 0f);
            spriteBatch.End();

        }

        /// Update the Tanks' position if it's not "close enough" to it's destination
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (moving)
            {
                ...
                // If we’re at the destination and there is at least one waypoint in the list, get rid of the first one since we’re there now
                ...
                if (!AtDestination)
                {
                    ...
                    //This scales the vector to 1, we'll use move Speed and elapsed Time to find the how far the tank moves
                    direction.Normalize();
                    location = location + (Direction * MoveSpeed * elapsedTime);
                }
            }
        }
        #endregion
