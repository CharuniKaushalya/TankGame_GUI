...
namespace Pathfinding
{
    ...
    public class Pathfinding : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            // gameplayArea => UI interface part having tileMap
        ...
        void HandleInput()
        {
            ...
            if (previousGamePadState.Buttons.A == ButtonState.Released && currentGamePadState.Buttons.A == ButtonState.Pressed ||
                previousKeyboardState.IsKeyUp(Keys.A) && currentKeyboardState.IsKeyDown(Keys.A))
            {
                pathFinder.IsSearching = !pathFinder.IsSearching;
            }

            if (previousGamePadState.Buttons.B == ButtonState.Released && currentGamePadState.Buttons.B == ButtonState.Pressed ||
                previousKeyboardState.IsKeyUp(Keys.B) && currentKeyboardState.IsKeyDown(Keys.B))
            {
                map.MapReload = true;
            }

            //if (previousGamePadState.Buttons.X == ButtonState.Released && currentGamePadState.Buttons.X == ButtonState.Pressed ||
            //    previousKeyboardState.IsKeyUp(Keys.X) && currentKeyboardState.IsKeyDown(Keys.X))
            //{
